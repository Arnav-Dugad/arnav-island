...
enum class Action { None,Overview,Media,System,Focus,Settings,Pin,Close,Play,Previous,Next,MediaMode,VolumeDown,Mute,VolumeUp,Timer25,Timer5,Stopwatch,TimerToggle,TimerReset,HoverToggle,HoverDelay,FullscreenToggle,ReducedToggle,MotionPreset,Offset,Monitor,SoundSettings,DisplaySettings,NetworkSettings,BluetoothSettings,Lab,Shelf,Audio,SettingsNext,StartupToggle,Theme,Scale,Corner,Edge,CompactWidth,CollapseDelay,GlassToggle,AccentsToggle,MagneticToggle,CompactMediaToggle,CompactBatteryToggle,Accent,AudioCompatibility,ShelfClear,SettingsReset,LayoutSlot,LayoutLeft,LayoutRight,MetricOne,MetricTwo,MetricThree,Rings,IconsToggle,HandoffToggle,LayoutReset,VolumeSlider,AppSwitchToggle,WheelVolumeToggle,Seek,UiMode,CompactVolumeToggle,CompactTimerToggle,CompactClockToggle,ShelfPeekToggle,WidthDown,HorizontalOffset,AudioApps,AudioOutputs,MixerSettings,DeviceBase=100,ShelfItemBase=200,MixerSliderBase=300,MixerMuteBase=340,SessionBase=380,ActionEnd=400 };
