...
// wallpaper: accent colour taken from the desktop wallpaper (0 when there is none).
struct PlatformInfo {std::wstring manufacturer,product,armoury;bool asus=false,rog=false;uint32_t wallpaper=0;};
